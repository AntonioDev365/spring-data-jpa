...
public class Student {
    ...
    //@ManyToMany(cascade ={CascadeType.PERSIST,CascadeType.REMOVE }) //this is no longer necessary since we created our enrolment composite key
   /* @JoinTable( //This annotation will create the new table in the many-to-many relationships
            name="enrolment",
    ...
    public void addCourse(Course course){
        courses.add(course);
        course.getStudents().add(this); //keep things in sync both ways
    }
